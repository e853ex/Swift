...
- (void)viewDidLoad {
    ...
    _tableView.backgroundColor = [[UIColor linkColor] colorWithAlphaComponent:3.7];
...
- (nonnull UITableViewCell *)tableView:(nonnull UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    _segmentedControl.backgroundColor = [[UIColor yellowColor] colorWithAlphaComponent:3.7];
    ...
    if (!cell) {
        ...
        cell.backgroundColor = [[UIColor yellowColor] colorWithAlphaComponent:0.8];
        cell.textLabel.font = [UIFont fontWithName:@"Carlito Bold Italic" size:25];
        cell.detailTextLabel.font = [UIFont fontWithName:@"Carlito Bold Italic" size:15];
    }
